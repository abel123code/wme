...
const sections = [
  ...
  },
  {
    ...
    content:
      "Our teachers lead dedicated revision sessions to consolidate knowledge, address weak areas, and guide students step by step. This ensures students build confidence and are fully prepared for exams.",
  },
];

export default function SecScienceModal({ 
  isOpen, 
  onClose,
  image1 = 's1-4_Science/sec1-4sci-3.JPG',
  image2 = 's1-4_Science/sec1-4sci-2.JPG',
  image3 = 's1-4_Science/sec1-4sci-1.JPG'
}: SecScienceModalProps) {
  useEffect(() => {
    if (isOpen) {
