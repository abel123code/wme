    ...
    >
      ...
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="shrink-0">
          {review.reviewer.profilePhotoUrl ? (
            ...
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#012DE8] to-[#E83789] flex items-center justify-center text-white font-bold text-lg">
        ...
        <div className="flex-1">
          ...
          {shouldTruncate && (
            <button
              ...
              className="text-[#012DE8] hover:underline text-sm mt-2 font-medium"
            >
      ...
      {review.reviewReply && (
        <div className="mt-4 pt-4 border-t border-gray-100">
          <p className="text-sm font-semibold text-gray-600 mb-1">Response from owner</p>
