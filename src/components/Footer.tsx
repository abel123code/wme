        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about#space" className="hover:underline">
                  Our Space
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/about#join" className="hover:underline">
                  Join Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>1 Jalan Anak Bukit #01-01Q, Bukit Timah Plaza</p>
              <p>Singapore 588996</p>
              <p>
                Phone:{" "}
                <a href="tel:+6589518938" className="hover:underline">
                  +65 8951 8938
                </a>
              </p>
              <p className="text-xs mt-2">
                Hours: Mon-Fri 2:30pm-8:30pm, Sat-Sun 10am-5pm, Closed on Public Holiday
              </p>
            </div>
          </div>
        </div>
